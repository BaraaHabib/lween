        ...
        children: [
          Row(
            ...
            children: [
              ...
              TextButton(
                onPressed: () => NavigationService.of(context).navigateTo(const CompaniesScreenRoute()),
                style: ButtonStyle(
              ...
              itemBuilder: (ctx, index) {
                ...
                return Column(
                  children: [
                    ...
                    7.vSpace,
                    AppTextWidget(entity.text,style: context.theme.textTheme.titleSmall,)
                  ],
                );
              },
            ),
